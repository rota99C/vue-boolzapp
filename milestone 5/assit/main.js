var app = new Vue({
    ...
    methods: {
        ...
        searchUser() {
            let inputText = this.cerca.toLowerCase()
            //console.log(inputText);
            this.contacts.forEach(contatto => {
                let singleName = contatto.name.toLowerCase()
                if (singleName.includes(inputText)) {
        ...
        showOption(i) {
            // console.log("click");
            let selectMessage = this.contacts[this.counter].messages[i]
